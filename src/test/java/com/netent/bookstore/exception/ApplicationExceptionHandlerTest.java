...
public class ApplicationExceptionHandlerTest {
  ...
  public void testResourcerNotFound() {
   ErrorResponseTemplate error = handler.resourceNotFound(resourceNotFound).getBody();
  ...
  @Test
  public void testServiceTiemoutNotFound() {
  Assertions.assertNotNull(handler.serviceRequestTimeoutException(serviceTiemout));
  }
  @Test
  public void testRemoteServiceNotFound() {
